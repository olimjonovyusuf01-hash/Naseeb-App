import 'package:flutter/material.dart';import 'package:flutter/services.dart';import 'dart:async';import 'dart:math' as math;import 'dart:ui';
void main() {
...
class _IslamPrayerAppState extends State<IslamPrayerApp> {
  ...
  String _currentBg = 'https://unsplash.com'; 
...
@override
State createState() => _PrayerHomeScreenState();
}
class _PrayerHomeScreenState extends State {
late Timer _timer;
...
@override
State createState() => _TasbihScreenState();
}
class _TasbihScreenState extends State {
int _counter = 0;
int _target = 33;
int _rounds = 0;
@override
...
final List _makkahBgs = const [
'unsplash.com',
'unsplash.com',
'unsplash.com'
];
final List _madinahBgs = const [
'unsplash.com',
'unsplash.com',
'unsplash.com'
];
...
Widget _buildBgHorizontalList(List list) {
return SizedBox(
height: 80,
child: ListView.builder(
...
bool isCurrent = currentBg.contains(list[i].split('?'));
return GestureDetector(
